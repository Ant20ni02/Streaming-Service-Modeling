...
void salida(vector<Video*>,vector<Usuario>){
  double contador=0;
      ...
      else if(Videos[i]->getGenero()=="Ciencia_ficcion"){contadorcf++;}
      else if(Videos[i]->getGenero() == "Drama"){contadord++;}
      else if(Videos[i]->getGenero()=="Terror"){contadort++;}
      else if(Videos[i]->getGenero() == "Comedia"){contadorc++;}
      else if(Videos[i]->getGenero() == "Aventura"){contadorav++;}
      else if(Videos[i]->getGenero() == "Accion"){contadorac++;}
